...
export const PLANS = {
  ...
  foundation: {
    ...
    features: [
      ...
      "Stack Safety Check - see interaction flag counts (details in Ultimate)",
  ...
  complete: {
    ...
    features: [
      ...
      "Supplement Cycling Tracker - automated on/off cycle tracking with reminders",
      "Stack Safety Check - full interaction details and timing guidance",
      "Milestone tracking, trend charts, and blood work log",
