...
export const MEAL_PLAN: MealPlanDay[] = [
  ...
  },
  {
    ...
    breakfast: { recipeId: null, name: "Oatmeal with walnuts, banana, cinnamon" },
  ...
  },
  {
    ...
    lunch: { recipeId: 25, name: "Sardines on Whole Grain Toast" },
  ...
  },
  {
    ...
    dinner: { recipeId: 17, name: "Testosterone Power Bowl (dinner size)" },
