  ...
  return (
    <div className="relative mt-1">
      <input
        ...
        className="block w-full rounded-md border border-zinc-700 bg-zinc-900 px-3 py-2 pr-10 text-white placeholder-zinc-500 focus:border-yellow-600 focus:outline-none focus:ring-1 focus:ring-yellow-600"
      />
      <button
        type="button"
