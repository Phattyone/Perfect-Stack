    ...
    <div className="min-h-screen bg-[#0a0a0a]">
      <nav className="sticky top-0 z-50 border-b border-zinc-800 bg-zinc-950/95 backdrop-blur">
        <div className="mx-auto flex max-w-4xl items-center justify-between px-6 py-4">
          <Link href="/" className="text-lg font-bold text-yellow-600">PerfectStack</Link>
      ...
      <main className="mx-auto max-w-3xl px-6 py-12">
        ...
        <div className="mt-8 space-y-8 text-sm leading-relaxed text-zinc-300">
          ...
          <section>
            ...
            <p>For privacy-related questions or requests, contact us at <span className="text-yellow-600">contact@perfectstack.com</span></p>
          </section>
        </div>
      </main>
